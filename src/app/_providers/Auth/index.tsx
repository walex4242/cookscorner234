...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const create = useCallback<Create>(async args => {
    try {
      const res = await fetch(`https://cookscornernc.com/api/users/create`, {
        method: 'POST',
        credentials: 'include',
        headers: {
  ...
  const login = useCallback<Login>(async args => {
    try {
      const res = await fetch(`https://cookscornernc.com/api/users/login`, {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const logout = useCallback<Logout>(async () => {
    try {
      const res = await fetch(`https://cookscornernc.com/api/users/logout`, {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  useEffect(() => {
    const fetchMe = async () => {
      try {
        const res = await fetch(`https://cookscornernc.com/api/users/me`, {
          method: 'GET',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json',
  ...
  const forgotPassword = useCallback<ForgotPassword>(async args => {
    try {
      const res = await fetch(`https://cookscornernc.com/api/users/forgot-password`, {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const resetPassword = useCallback<ResetPassword>(async args => {
    try {
      const res = await fetch(`https://cookscornernc.com/api/users/reset-password`, {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
